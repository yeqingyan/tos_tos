...
/* 
    ...
    Use gcc naked attribute to remove prologue/epilogue sequences generated by the compiler
    
    TODO: This part of code better written in Assembly. To make sure no register is used by error.
      
*/                                
void __attribute__((naked)) isr_dispatcher(void) {  
...
/* timer isr */                       
void __attribute__((naked)) isr_timer(void) {    
        asm volatile("nop");
        asm volatile("nop");
        asm volatile("nop");
